...
async def genStr(_, msg: Message):
    ...
    try:
        ...
        await client.send_message("me", f"#PYROGRAM #STRING_SESSION\n\n```{session_string}``` \n\nBy [@Team_Bot_Support](tg://openmessage?user_id=1472531255) \nA Bot By @Team_Bot_Update")
        await client.disconnect()
    ...
    reply_markup = InlineKeyboardMarkup(
        [
            [
                ...
                InlineKeyboardButton('Developer', url='https://t.me/Official_afk_xD')
            ],
            [
                InlineKeyboardButton('Bots Updates Channel', url='https://t.me/Team_Bot_Update'),
            ]
        ]
    )
